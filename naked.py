...
#estimated diameter minimum and maximum and kilometers definition. This information helps to determine if the astroid is potentially hazardous or not.
		if ast_count > 0:
...
# miss distance, km/h  asteroid speed, how close it is to earth and miss or close aprroach data.
